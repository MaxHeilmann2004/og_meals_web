              ...
              >
                ...
                >
                  <MealAdminTools
                    ...
                    @images-updated="updateMealImages"
                  />
                </var-collapse-item>
              </var-collapse>
            </div>
...
import { formatMealShortDate } from '~/utils/meal/formatters'
...
const updateMealImages = (images: MealImageDto[]) => {
  if (localMeal.value) localMeal.value.images = images
}
